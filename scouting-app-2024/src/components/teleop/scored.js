    ...
    <div style={{
      ...
      <div style={{ width: '100%', gap: 23, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div style={{ width: 30, height: 30, position: 'relative' }}>
          <div style={{ width: 25, height: 25, left: 2.50, top: 2.50, position: 'absolute', background: '#B9FFE6' }}></div>
        </div>
        <div style={{ color: '#B9FFE6', fontSize: 22, fontWeight: '600', wordWrap: 'break-word' }}>846 Scored Speaker</div>
      </div>
    </div>
  );
};
