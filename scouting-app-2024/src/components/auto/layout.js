  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <p className={somethingnonono ? "hide" : "show"} style = {{marginBottom: 0, fontFamily: 'Poppins', fontSize: '20px', fontStyle: 'normal', lineHeight: 'normal', fontWeight: '600', color: '#7d7d7d', }}>Pre Note Scored?</p>
