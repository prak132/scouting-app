...
function App() {
  ...
  async function handleStoreDataClick() {
    ...
    localStorage.setItem("2024sunshow_qm"+matchValue, JSON.stringify(data));
    console.log(`Data stored for match 2024sunshow_qm+${matchValue}`);
  }
  ...
  async function handleSendDataClick() {
    if (!localStorage.getItem("2024sunshow_qm"+matchValue)) {
